...
* The original package name 'space.rodrigorocha.short-url.url-read-projector' is invalid and this project uses 'space.rodrigorocha.short_url.url_read_projector' instead.
