...
* The original package name 'space.rodrigorocha.short-url.short-url-creator' is invalid and this project uses 'space.rodrigorocha.short_url.short_url_creator' instead.
