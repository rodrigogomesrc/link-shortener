...
public class UrlController {
    ...
    @PostMapping
    public ResponseEntity<String> createShortUrl(@RequestBody @Valid CreateShortUrlRecord payload) {
        return ResponseEntity.ok(service.createShortUrl(payload));
    }

    @PostMapping("/custom")
    public ResponseEntity<String> createCustomUrl(@RequestBody @Valid CreateCustomUrlRecord payload) {
